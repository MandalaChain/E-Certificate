...
export interface LevyContract extends BaseContract {
  ...
  getVoucherDetails: TypedContractMethod<
    [idVoucher: BytesLike, tokenId: BigNumberish],
  ...
  issueVoucher: TypedContractMethod<
    [
      nameVisiotor: string,
      email: string,
  ...
  validateVoucher: TypedContractMethod<
    [idVoucher: BytesLike, tokenId: BigNumberish],
    [boolean],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getVoucherDetails"
  ): TypedContractMethod<
    [idVoucher: BytesLike, tokenId: BigNumberish],
    [[string, string, string, bigint, bigint]],
    "view"
  ...
  getFunction(
    nameOrSignature: "validateVoucher"
  ): TypedContractMethod<
    [idVoucher: BytesLike, tokenId: BigNumberish],
    [boolean],
    "nonpayable"
  ...
  filters: {
    ...
    "VoucherIssued(bytes32,uint256,uint256)": TypedContractEvent<
      VoucherIssuedEvent.InputTuple,
      VoucherIssuedEvent.OutputTuple,
      VoucherIssuedEvent.OutputObject
    >;
    ...
    "VoucherValidated(bytes32,uint256,bool)": TypedContractEvent<
      VoucherValidatedEvent.InputTuple,
      VoucherValidatedEvent.OutputTuple,
      VoucherValidatedEvent.OutputObject
    >;
